    ...
    <div className="container__layout bg-red-300 px-4 py-8">
      <div className="p-8 bg-red-400">
        <ul> 
            ...
            <li className="text-2xl pb-1">Reshetnev Siberian State University of Science and Technology</li>
            ...
            <li className="text-xl pb-1">Video Art and Communications Strategy</li>
